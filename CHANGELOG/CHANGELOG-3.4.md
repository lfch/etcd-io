...
- Upgrade [`github.com/lfch/grpc`](https://github.com/grpc/grpc-go/releases) from [**`v1.23.0`**](https://github.com/grpc/grpc-go/releases/tag/v1.23.0) to [**`v1.23.1`**](https://github.com/grpc/grpc-go/releases/tag/v1.23.1).
...
- Move [`"github.com/coreos/etcd"`](https://github.com/etcd-io/etcd/issues/9965) to [`"github.com/etcd-io/etcd"`](https://github.com/etcd-io/etcd/issues/9965).
  - Change import path to `"github.com/lfch/etcd-io"`.
  - e.g. `import "github.com/lfch/etcd-io/raft"`.
...
- Deprecated [`grpc.ErrClientConnClosing`](https://github.com/etcd-io/etcd/pull/10981).
  ...
  - Use `clientv3.IsConnCanceled(error)` or `github.com/lfch/grpc/status.FromError(error)` instead.
...
- Move internal packages to `etcdserver`.
  - `"github.com/coreos/etcd/alarm"` to `"github.com/lfch/etcd-io/etcdserver/api/v3alarm"`.
  - `"github.com/coreos/etcd/compactor"` to `"github.com/lfch/etcd-io/etcdserver/api/v3compactor"`.
  - `"github.com/coreos/etcd/discovery"` to `"github.com/lfch/etcd-io/etcdserver/api/v2discovery"`.
  - `"github.com/coreos/etcd/etcdserver/auth"` to `"github.com/lfch/etcd-io/etcdserver/api/v2auth"`.
  - `"github.com/coreos/etcd/etcdserver/membership"` to `"github.com/lfch/etcd-io/etcdserver/api/membership"`.
  - `"github.com/coreos/etcd/etcdserver/stats"` to `"github.com/lfch/etcd-io/etcdserver/api/v2stats"`.
  - `"github.com/coreos/etcd/error"` to `"github.com/lfch/etcd-io/etcdserver/api/v2error"`.
  - `"github.com/coreos/etcd/rafthttp"` to `"github.com/lfch/etcd-io/etcdserver/api/rafthttp"`.
  - `"github.com/coreos/etcd/snap"` to `"github.com/lfch/etcd-io/etcdserver/api/snap"`.
  - `"github.com/coreos/etcd/store"` to `"github.com/lfch/etcd-io/etcdserver/api/v2store"`.
...
- Change [`pkg/adt.IntervalTree` from `struct` to `interface`](https://github.com/etcd-io/etcd/pull/10959).
  - See [`pkg/adt` README](https://github.com/etcd-io/etcd/tree/main/pkg/adt) and [`pkg/adt` godoc](https://godoc.org/github.com/lfch/etcd-io/pkg/adt).
...
- Upgrade [`github.com/lfch/grpc`](https://github.com/grpc/grpc-go/releases) from [**`v1.7.5`**](https://github.com/grpc/grpc-go/releases/tag/v1.7.5) to [**`v1.23.0`**](https://github.com/grpc/grpc-go/releases/tag/v1.23.0).

...
import (
	...
	etcdservergw "github.com/lfch/etcd-io/api/v3/etcdserverpb/gw"
	...
	"github.com/lfch/etcd-io/pkg/v3/httputil"
	"github.com/lfch/etcd-io/server/v3/config"
	"github.com/lfch/etcd-io/server/v3/etcdserver"
	"github.com/lfch/etcd-io/server/v3/etcdserver/api/v3client"
	"github.com/lfch/etcd-io/server/v3/etcdserver/api/v3election"
	"github.com/lfch/etcd-io/server/v3/etcdserver/api/v3election/v3electionpb"
	v3electiongw "github.com/lfch/etcd-io/server/v3/etcdserver/api/v3election/v3electionpb/gw"
	"github.com/lfch/etcd-io/server/v3/etcdserver/api/v3lock"
	"github.com/lfch/etcd-io/server/v3/etcdserver/api/v3lock/v3lockpb"
	v3lockgw "github.com/lfch/etcd-io/server/v3/etcdserver/api/v3lock/v3lockpb/gw"
	"github.com/lfch/etcd-io/server/v3/etcdserver/api/v3rpc"

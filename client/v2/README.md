...
[![GoDoc](https://godoc.org/github.com/lfch/etcd-io/client?status.png)](https://godoc.org/github.com/lfch/etcd-io/client)
...
```bash
go get github.com/lfch/etcd-io/v3/client
```
...
import (
    ...
    "github.com/lfch/etcd-io/v3/client"
)
